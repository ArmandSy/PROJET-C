...
main.o: main.c affichage.h boats.h trafficlights.h vehicules.h
	gcc -c -Wall main.c
PROJET: affichage.o boats.o trafficlights.o vehicules.o main.o 
	gcc -o PROJET main.o affichage.o boats.o trafficlights.o vehicules.o
EXECUTION: 
	./PROJET
