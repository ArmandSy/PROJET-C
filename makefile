...
main.o: main.c affichage.h boats.h decision.h helicopteres.h pietons.h trafficlights.h tramways.h vehicules.h
	gcc -c -Wall -g -ggdb main.c
PROJET: affichage.o boats.o decision.o helicopteres.o pietons.o trafficlights.o tramways.o vehicules.o main.o 
	gcc -o PROJET main.o affichage.o boats.o decision.o helicopteres.o pietons.o trafficlights.o tramways.o vehicules.o
EXECUTION: 
	./PROJET
